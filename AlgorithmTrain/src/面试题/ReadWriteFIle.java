...
public class ReadWriteFIle {
    ...
    public static void main(String[] args) {
        ...
        ArrayBlockingQueue<Future<Map<String, FileInputStream>>> queue =
    ...
    static class MyCallableProducer implements Callable<Map<String,FileInputStream>>
    {
        ...
        private Map<String,FileInputStream> fileMap = new HashMap<>();
    ...
    static class MyCallableConsumer implements Runnable
    {
        ...
        private BlockingDeque<Future<Map<String,FileInputStream>>> queue;
        private FileInputStream fis = null;
        ...
        public MyCallableConsumer(BlockingQueue<Future<Map<String, FileInputStream>>> queue2) {
            this.queue = (BlockingDeque<Future<Map<String, FileInputStream>>>) queue2;
        }
        ...
        public void run() {
            try {
                Future<Map<String,FileInputStream>> future = (Future<Map<String, FileInputStream>>) queue.take();
